...
- [1. Вступ, вимоги та встановлення](#1-вступ-вимоги-та-встановлення-1)
...
- [3. Огляд / Дашборд](#3-огляд--дашборд-1)
...
- [10. Підписки (Subscription)](#10-підписки-subscription-1)
...
- [11. Xray: маршрутизація, outbounds, DNS та розширення](#11-xray-маршрутизація-outbounds-dns-та-розширення-1)
...
- [12. Вузли (мультипанель, master/slave)](#12-вузли-мультипанель-masterslave-1)
...
- [14. Telegram-бот](#14-telegram-бот-1)
