...
- [6. 传输层（Stream Settings）](#6-传输层stream-settings)
  ...
  - [6.9. 相关参数](#69-相关参数)
- [7. 连接安全：TLS、XTLS 与 REALITY](#7-连接安全tlsxtls-与-reality-1)
...
- [10. 订阅（Subscription）](#10-订阅subscription-1)
...
- [11. Xray：路由、outbounds、DNS 与扩展](#11-xray路由outboundsdns-与扩展-1)
...
- [12. 节点（多面板，master/slave）](#12-节点多面板masterslave-1)
...
- [14. Telegram 机器人](#14-telegram-机器人-1)
