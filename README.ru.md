...
Руководство пользователя панели [3x-ui](https://github.com/MHSanaei/3x-ui) — подробный гайд без отсылок к исходному коду, написанный под панель **v3.3.1**.
...
| Файл | Язык | Формат |
| --- | --- | --- |
| **[3X-UI-MANUAL.ru.md](3X-UI-MANUAL.ru.md)** · [PDF](3X-UI-MANUAL.ru.pdf) | 🇷🇺 Русский — **каноничный** (правим в первую очередь) | Markdown + PDF |
