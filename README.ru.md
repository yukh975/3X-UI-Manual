...
Руководство пользователя панели [3x-ui](https://github.com/MHSanaei/3x-ui) — подробный гайд, написанный под панель **v3.3.0**.
...
**3.3.0 — первая задокументированная версия** руководства. Это базовая точка отсчёта, поэтому раздела со сводкой изменений относительно предыдущей версии здесь нет — изменения последующих версий описаны в их ветках.
