...
**Версия 3X-UI: 3.4.2.** Руководство составлено по этой версии и актуально для неё. Сводка изменений 3.4.2 относительно 3.4.1 — в разделе [«Что нового в 3.4.2»](#что-нового-в-342).
...
- [Что нового в 3.4.2](#что-нового-в-342)
...
Здесь `v25.6.8` — тег из списка, который отдаёт `GET /getXrayVersion`. Версия обязана присутствовать в этом списке, иначе панель ответит отказом. С версии 3.4.2 минимально допустимая для установки версия Xray поднята до **26.6.27** (в комплекте идёт ядро Xray 26.6.27), поэтому более старые сборки для обновления недоступны.
...
| «Разрешённые IP WireGuard» | Только для чтения (в режиме редактирования): выданный клиенту адрес в туннеле, например `10.0.0.2/32` |
