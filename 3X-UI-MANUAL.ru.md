...
**Версия 3X-UI: 3.5.0.** Руководство составлено по этой версии и актуально для неё. Сводка изменений 3.5.0 относительно 3.4.2 — в разделе [«Что нового в 3.5.0»](#что-нового-в-350).
...
- [Что нового в 3.5.0](#что-нового-в-350)
...
| **Мин. версия клиента** (`minClientVer`) | `""` | Минимальная версия Xray-клиента (плейсхолдер с 3.5.0 — `26.3.27`). Пусто — без ограничения. |
